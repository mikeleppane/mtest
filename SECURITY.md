...
Include the affected version, platform, Mojo version, reproduction steps or a
minimal test project, impact, and any known workaround. Reports stay private
while a fix and disclosure are coordinated. The project does not promise a
fixed response time.
