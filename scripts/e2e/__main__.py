...
SCENARIOS: ScenarioRegistry = (
    ...
    ("debug-hands-over", dev_loop.s_debug_hands_over),
    ("debug-refusals", dev_loop.s_debug_refusals),
    ("debug-environment", dev_loop.s_debug_environment),
    ("debug-default-sigpipe", dev_loop.s_debug_default_sigpipe),
